...
import com.hotyi.hotyi.activity.MainActivity;
import com.hotyi.hotyi.activity.NewFriendListActivity;
import com.hotyi.hotyi.broadcast.BroadcastManager;
import com.hotyi.hotyi.other.hotyiClass.HotyiConst;
import com.hotyi.hotyi.other.pinyin.CharacterParser;
import com.hotyi.hotyi.other.response.ContactNotificationMessageData;
import com.hotyi.hotyi.utils.HotyiExtensionModule;
import com.hotyi.hotyi.utils.HttpException;
import com.hotyi.hotyi.utils.JsonMananger;
import com.hotyi.hotyi.utils.db.Friend;
    ...
    private void setInputProvider() {
        ...
        if (moduleList != null) {
            ...
            if (defaultModule != null) {
                ...
                RongExtensionManager.getInstance().registerExtensionModule(new HotyiExtensionModule());
            }
        }
    }
...
//        NLog.d(TAG, "ConnectionStatus onChanged = " + connectionStatus.getMessage());
    ...
    public void popAllActivity() {
        try {
            if (MainActivity.myViewPager != null) {
                MainActivity.myViewPager.setCurrentItem(0);
            }
...
//                NLog.d(TAG, "ConnectCallback connect onSuccess");
                ...
                sp.edit().putString(HotyiConst.SEALTALK_LOGIN_ID, s).apply();
            }
...
//                NLog.d(TAG, "ConnectCallback connect onError-ErrorCode=" + e);
    ...
    private void quit(boolean isKicked) {
        ...
        editor.putString(HotyiConst.SEALTALK_LOGIN_ID, "");
