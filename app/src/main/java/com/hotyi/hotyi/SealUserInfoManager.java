...
import com.hotyi.hotyi.other.RongGenerate;
import com.hotyi.hotyi.other.pinyin.CharacterParser;
import com.hotyi.hotyi.other.response.GetBlackListResponse;
import com.hotyi.hotyi.other.response.GetGroupInfoResponse;
import com.hotyi.hotyi.other.response.GetGroupMemberResponse;
...
import com.hotyi.hotyi.utils.db.BlackListDao;
import com.hotyi.hotyi.utils.db.DBManager;
import com.hotyi.hotyi.utils.db.Friend;
import com.hotyi.hotyi.utils.db.FriendDao;
import com.hotyi.hotyi.utils.db.GroupMember;
import com.hotyi.hotyi.utils.db.GroupMemberDao;
import com.hotyi.hotyi.utils.db.Groups;
    ...
    public void getUserInfo(final String userId) {
        ...
        if (mUserInfoCache != null) {
            ...
            if (userInfo != null) {
               ...
               // NLog.d(TAG, "SealUserInfoManager getUserInfo from cache " + userId + " "+ userInfo.getName() + " " + userInfo.getPortraitUri());
                return;
            }
        }
